...
class FloatingButtonLogin extends StatelessWidget {
  final double bottomMargin;
  final bool isVisible;

  const FloatingButtonLogin({Key key, this.bottomMargin, this.isVisible})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Positioned(
        ...
        child: AnimatedOpacity(
            opacity: isVisible ? 1 : 0,
            duration: Duration(milliseconds: 200),
            child: Text("Get moving with Hyperloop",
