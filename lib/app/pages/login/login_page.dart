...
import 'package:hyperloop/app/widgets/phone_auth_widgets.dart';
      ...
      body: SafeArea(
        child: Center(
          child: SingleChildScrollView(
            child: Card(
              color: Color(Constants.cardBackgroundColor),
              elevation: 2.0,
          ...
          children: <Widget>[
            Padding(
              ...
              child: PhoneAuthWidgets.getLogo(
                  logoPath: Resources.logo, height: _height * 0.2),
            ),
              ...
              switch (code.length) {
                ...
                case 6:
                  BlocProvider.of<AuthenticationBloc>(context)
                      .add(SignInWithPhone(smsCode: code));
                  break;
                default:
          ...
          children: <Widget>[
            ...
            RaisedButton(
              ...
              onPressed: () {
                ...
                BlocProvider.of<AuthenticationBloc>(context)
                    .add(VerifyPhone(phoneNumber: phoneNumber));
              },
              child: Padding(
